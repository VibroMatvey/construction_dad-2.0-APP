        ...
        <div class="collapse navbar-collapse flex-grow items-center" id="navbarSupportedContent">
          <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
            <li class="nav-item p-2">
              <RouterLink class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to="/">Главная
              </RouterLink>
            </li>
            <li class="nav-item p-2">
              <RouterLink
                  class="peer nav-link block text-gray-500 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out dropdown-toggle flex items-center whitespace-nowrap"
            ...
            <li class="nav-item p-2">
              <RouterLink class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to="/about">О нас
              </RouterLink>
            </li>
          </ul>
        </div>
